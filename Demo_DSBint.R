###Demo for DSB simulator###
##Run this script to produce a DSB simulation##
...
###Calling function- edit with desired parameters

DSBInt(WTmap = './Data/AVERAGE_HOTSPOT_TABLES/T_0.193_Hotspot.Table.sae2Dndt80D.txt',
       tel1Dmap = './Data/AVERAGE_HOTSPOT_TABLES/T_0.193_Hotspot.Table.sae2Dndt80Dtel1D.txt',
       G = 1e7) #depth of sim, reduce if simulation is taking too long
